...
namespace JungleStack
{
    class Program
    {
        ...
        private static readonly Vector3[] StackRouteRadiant =
        {
            ...
            new Vector3(-4343,-2046,256), // Move for pulling
            new Vector3(-2627,-525,256) // Wait position
        };

        private static readonly Vector3[] StackRouteDire =
        {
            new Vector3(3402, -550, 127),  // Wait for attack
            new Vector3(4902, 450, 256), // Move for pulling
            new Vector3(3302, -550, 127) // Wait position
        };
